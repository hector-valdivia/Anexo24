			...
			<div class="col-md12">
				<div class="grid simple">
					...
					<div class="grid-body">
						<div class="grid simple">
							<div class="row">
								<div class="col-md-12"><h4>Informacion del proveedor/cliente</h4></div>
							</div>

							<div class="row">
								<div class="col-md-3">
									<div class="form-group">
										<label class="form-label">Cliente / Proveedor <span id="bidfiscal" class="help"></span></label>
										<div class="controls">
								...
								<div class="col-md-2">
									<div class="form-group">
										...
										<div class="controls">
											<input type="text" name="incoterm" class="form-control incoterm" />
										</div>
									</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
										...
										<div class="controls">
											<select name="moneda_factura" class="form-control moneda_factura">{OPTMONEDA}</select>
										</div>
									</div>
								</div>
							</div>
							<div class="row">
								<div class="col-md-2">
									<div class="form-group">
										<label class="form-label">Numero de Embarque</label>
										<div class="controls">
											<input type="text" name="numero_embarque" class="form-control numero_embarque" />
										</div>
									</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
										...
										<div class="controls">
											<input type="date" name="fecha_embarque" class="form-control fecha_embarque" />
										</div>
									</div>
								</div>
								<div class="col-md-2">
									<div class="form-group">
										...
										<div class="controls">
											<input type="text" name="pais_destino" class="form-control pais_destino" />
										</div>
									</div>
								</div>
							</div>
			...
			$.enviar({ 'Method':'getDisplay' }).done(function(r){
				if ( r.r == 1 ){
					...
					$.each(r.moneda,function(i,m){
						$('.moneda_factura')[0].add( new Option(m.abbr_mon,m.id_mon) );
					});
				}
			});
